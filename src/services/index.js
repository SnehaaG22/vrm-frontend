...
export const evidenceService = {
  ...
  getExpiryWarning: (expiresInDays) => {
    ...
    if (expiresInDays < 7) return { level: 'critical', message: `Expires in ${expiresInDays} days` };
    if (expiresInDays < 30) return { level: 'warning', message: `Expires in ${expiresInDays} days` };
